...
double wall_time;
double FRR,Q2,Dr,temp,temp2,temp3,dt,tend,p,t_elap,sum,umag,phi0,theta0,sqrtm8,thetai,phii;
...
// unsigned long *idum;
// long idum;
double eye[9],u[3],un[3],uu[9],dF[3],dW[3],R[3],eye_m_uu_x_Gd[9],sqrtm[9],A[9],Gdt[9];
