...
if __name__ == '__main__':
    ...
    h = pickle.load(open('../autoencoder/dPCA%d/rmodel%d/encoded_data.p'%(dPCA,ae_model),'rb'))
    print(h.shape)
    ornt = pickle.load(open(data_dir+'na200_nq_100_qlim_0.10_L1680.0_R34.0/orntcs_snaps_%d.p'%data_size,'rb'))
    ...
    wdir = 'rdh%d/dPCA%d/arch%d_tau%d_alpha%.1e/model%d'%(dh,dPCA,arch,batch_time,alpha,model)
