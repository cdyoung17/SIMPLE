...
if __name__ == '__main__':
    ...
    IQa = pickle.load(open(I_path+'IQphase_FRR_%.2f_Q2_%.2f_strm_%d.p'%(FRR,Q2,strm),'rb'))
    ...
    if args.movie == 1:
        ...
        ax3 = plt.subplot(131)
        cax3 = ax3.pcolormesh(qxlist,qylist,Irot[0],norm=colors.LogNorm(vmin=vmin),cmap=mymap,shading='gouraud')
        ...
        ax4 = plt.subplot(132)
        cax4 = ax4.pcolormesh(qxlist,qylist,Ihtr[0],norm=colors.LogNorm(vmin=vmin),cmap=mymap,shading='gouraud')
        ...
        cax2 = ax2.pcolormesh(qxlist,qylist,np.sqrt((Irot[0] - Ihtr[0])**2),norm=colors.LogNorm(vmin=errmin,vmax=errmax),cmap=mymap,shading='gouraud')
        ...
        def animate(i):
           ...
           cax3.set_array(Irot[i])
           cax4.set_array(Ihtr[i])
           cax2.set_array(np.sqrt((Irot[i] - Ihtr[i])**2))
