	...
	for Pe in Pelist:
		for al in alpha:
			for tr in traj:
				...
				jobfile.write("./l2c_pred_test.py --batch_time %d --dh %d --alpha %f --dir %s --ae_model %d --data_size %d --arch %d --traj %d --movie %d --flowType %.2f --Pe %f --dt %f\n"%(t,dh,al,wdir,ae_model,data_size,arch,tr,movie,flowType,Pe,avg_win[count]))
