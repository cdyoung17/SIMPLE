...
if __name__ == '__main__':
    ...
    print(h.shape)
    Q,phase_t = pickle.load(open(data_dir+args.dir+'_na200_nq_100_qlim_0.10_L1680.0_R34.0/Qphase_snaps_%d.p'%data_size,'rb'))
    grad,E = pickle.load(open(data_dir+args.dir+'_na200_nq_100_qlim_0.10_L1680.0_R34.0/GdotE_snaps_%d.p'%data_size,'rb'))
